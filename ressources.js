...
<<<<<<< HEAD
  ...
  {type:"livre", cat:"Mathématiques", niveau:"Toutes années", title:"Maths — Exercices incontournables MPSI-MP2I", author:"M. Bages · Dunod", isbn:"9782100828845",
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"Toutes années", title:"Physique tout-en-un MPSI-MP2I", author:"B. Salamito, M.-N. Sanz · Dunod", isbn:"9782100879229", featured:true,
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"Toutes années", title:"Chimie tout-en-un MPSI", author:"B. Fosset · Dunod", isbn:"9782100864638",
  ...
  {type:"livre", cat:"Mathématiques", niveau:"Toutes années", title:"Maths PCSI — Tout-en-un", author:"C. Deschamps · Dunod (J'intègre)", isbn:"9782100863952", featured:true,
  ...
  {type:"livre", cat:"Mathématiques", niveau:"Toutes années", title:"Maths PCSI-PTSI — Méthodes et exercices", author:"J.-M. Monier · Dunod", isbn:"9782100862429",
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"Toutes années", title:"Physique tout-en-un PCSI", author:"S. Cardini, B. Salamito · Dunod", isbn:"9782100864652", featured:true,
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"Toutes années", title:"Chimie tout-en-un PCSI", author:"B. Fosset · Dunod", isbn:"9782100864645",
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"Toutes années", title:"Sciences industrielles pour l'ingénieur — Tout-en-un", author:"J.-D. Mosser · Dunod", isbn:"9782100828739",
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"Toutes années", title:"Informatique avec Python — Méthodes et exercices", author:"J.-N. Beury · Dunod", isbn:"9782100879267",
  ...
  {type:"doc", cat:"Annales & concours", niveau:"Toutes années", title:"Annales blanches 2025 — Maths & Physique", author:"RACP-IMSP · PDF", featured:true,
  ...
  {type:"doc", cat:"Annales & concours", niveau:"Toutes années", title:"Doc Solus — annales corrigées", author:"doc-solus.fr", featured:true,
   desc:"Énoncés et corrigés des concours CCINP, Centrale-Supélec, Mines-Ponts et Polytechnique.", url:"https://www.doc-solus.fr/"},
  {type:"doc", cat:"Annales & concours", niveau:"Toutes années", title:"Bibmath — cours & exercices CPGE", author:"bibmath.net",
   desc:"Cours, exercices et annales de math sup / math spé (MPSI, PCSI, MP, PC).", url:"https://www.bibmath.net/"},
  {type:"doc", cat:"Annales & concours", niveau:"Toutes années", title:"Maths-France", author:"maths-france.fr",
  ...
  {type:"doc", cat:"Mathématiques", niveau:"Toutes années", title:"Exo7 — cours & exercices de maths", author:"exo7.emath.fr", featured:true,
  ...
  {type:"livre", cat:"Mathématiques", niveau:"3e année", title:"Algebraic Topology — A. Hatcher", author:"Allen Hatcher · Cornell",
  ...
  {type:"livre", cat:"Mathématiques", niveau:"3e année", title:"Introduction to Statistical Learning (ISLR)", author:"James, Witten, Hastie, Tibshirani", featured:true,
  ...
  {type:"livre", cat:"Mathématiques", niveau:"3e année", title:"The Elements of Statistical Learning (ESL)", author:"Hastie, Tibshirani, Friedman",
  ...
  {type:"livre", cat:"Physique & sciences", niveau:"3e année", title:"Algorithms — J. Erickson", author:"Jeff Erickson · Illinois",
   desc:"Manuel complet d'algorithmique et de complexité (24 Mo, PDF téléchargeable depuis le site). En anglais.", url:"assets/docs/algorithms-jeff-erickson.pdf",
   credit:{auteur:"Jeff Erickson (University of Illinois Urbana-Champaign)", licence:"CC BY 4.0",
...
<<<<<<< HEAD
  ...
  {type:"video", cat:"Méthode & orientation", niveau:"Toutes années", title:"La Tronche en Biais", author:"Thomas C. Durand · zététique",
  ...
  {type:"video", cat:"Physique & sciences", niveau:"Toutes années", title:"Emmanuel Djegou (FR)", author:"IA · statistiques · data science",
  ...
  {type:"video", cat:"Mathématiques", niveau:"3e année", title:"StatQuest", author:"Josh Starmer",
...
<<<<<<< HEAD
  /* --- Stats d'en-tête (accès libre = tout sauf les livres commerciaux Dunod) ---
     ...
     par leur type sous-évaluerait le compteur. */
  (function stats(){
...
>>>>>>> 4deba6d7825e93572eb83fb1df5b276af63ab0d7
  ...
  /* --- Crédits & licences des fichiers hébergés sur le site ---
     Les œuvres sous Creative Commons redistribuées ici doivent citer leur auteur,
     leur licence et leur source. Ce bloc est généré depuis le champ `credit` :
     ajouter `credit:{…}` à une entrée suffit pour qu'elle y apparaisse. */
  (function renderCredits(){
    const box=document.getElementById('lib-credits');
    if(!box) return;
    const items=LIB.filter(r=>r.credit);
    if(!items.length){ box.hidden=true; return; }
    box.innerHTML=`<h2 class="title">Crédits &amp; licences</h2>
      <p class="muted">Les documents ci-dessous sont hébergés sur ce site avec l'autorisation de leur licence
      d'origine. Merci à leurs auteurs de les rendre librement accessibles.</p>
      <ul class="lib-credits-list">${items.map(r=>{
        const c=r.credit;
        return `<li>
          <b>${esc(r.title)}</b> — ${esc(c.auteur)}.
          Sous licence <a href="${esc(c.licenceUrl)}" target="_blank" rel="noopener license">${esc(c.licence)}</a>,
          <a href="${esc(c.source)}" target="_blank" rel="noopener">source originale</a>.
